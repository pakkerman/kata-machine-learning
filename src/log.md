...
- [x] TwoCrystalBalls     13m,  ZERO DEATH
- [x] CompareBinaryTrees  3m,   ZERO DEATH
- [x] DFSOnBST            5m,   ZERO DEATH

## Apr 29 2023
## Linked Lists
- [x] ArrayList           15m
- [x] SinglyLinkedList    35m,  removeAt, need to set curr as tail if curr.next is the tail
- [x] DoublyLinkedLists   15m 
...
#### Search
- [ ] LinearSearchLists
- [x] BinarySearchList    4m, ZERO DEATH
- [ ] BFSGraphMatrix
...
## Apr 30 2023
## Linked Lists
- [x] ArrayList           14m,  removeAt for loop is off by one, remove if inside the for loop should be ===
- [x] SinglyLinkedList    20m,  close to ZERO DEATH, in append wrongly set head and tail to undefined
- [x] DoublyLinkedLists   10m,  didnt set append and prepend when length is 1, head and tail to new node
- [x] Queue               3m,   ZERO DEATH
...
- [ ] BubbleSort
#### Search
- [x] LinearSearchLists   1m
- [x] BinarySearchList    2m,   ZERO DEATH
- [ ] BFSGraphMatrix      
- [x] BTBFS               3m,   ZERO DEATH
#### Tree Traversal
- [x] CompareBinaryTrees  1m,   ZERO DEATH
- [x] BTInOrder           4m,   TRIPLE ZERO DEATH
- [x] BTPostOrder         4m,   TRIPLE ZERO DEATH
- [x] BtPreOrder          4m,   TRIPLE ZERO DEATH
- [ ] DFSGraphList
- [x] DFSOnBST            3m,  
- [ ] DijkstralList
- [ ] LRU
...
## May 01 2023
## Linked Lists
- [x] ArrayList             11m   curse by 'off by one',
- [x] SinglyLinkedList      17m   REMEMBER BOOK KEEPING!
- [x] DoublyLinkedLists     10m   append and prepend head and tail = node if length = 0
- [x] Queue                 3m    ZERO DEATH
- [x] Stack                 3m    ZERO DEATH
### Sort
- [x] QuickSort             rewatched
- [x] BubbleSort            rewatched
#### Search
- [ ] LinearSearchLists
- [x] BinarySearchList      - 2m    mixed up if statement of needle < value
- [ ] BFSGraphMatrix
- [x] BTBFS                 2.5m  ZERO DEATH
#### Tree Traversal
- [x] CompareBinaryTrees    1.5m  ZERO DEATH
- [x] BTInOrder             4m    TRIPLE ZERO DEATH
- [x] BTPostOrder           4m    TRIPLE ZERO DEATH
- [x] BtPreOrder            4m    TRIPLE ZERO DEATH
- [ ] DFSGraphList
- [x] DFSOnBST              2.5m  ZERO DEATH
- [ ] DijkstralList
- [ ] LRU
- [ ] Map
- [ ] MinHeap
...
#### Challenge
- [ ] MazeSolver
- [x] TwoCrystalBalls       2m    Accidently using this.length instaead of breaks.length

# May 02 2023
## Linked Lists
- [x] ArrayList             15m
- [x] SinglyLinkedList      25m   god fucking damnit
- [x] DoublyLinkedLists     13m   ZERO DEATH
...
- [x] DoublyLinkedLists     12m   ZERO DEATH
- [x] Queue                 3m    ZERO DEATH
- [x] Stack                 4m
### Sort
- [x] QuickSort             5m    ZERO DEATH
- [x] BubbleSort            2m    ZERO DEATH
#### Search
- [x] LinearSearchLists     1m    ZERO DEATH
- [x] BinarySearchList      3m    
...
- [x] LinearSearchLists     1m
- [x] BinarySearchList      3m
- [x] BFSGraphMatrix        10    premature exit while loop 
- [x] BTBFS                 2m    ZERO DEATH
#### Tree Traversal
- [x] CompareBinaryTrees    1m    ZERO DEATH
- [x] BTInOrder             1m    ZERO DEATH
...
- [x] ArrayList             7m    ZERO DEATH
- [x] SinglyLinkedList      9m    ZERO DEATH
- [x] DoublyLinkedLists     2.5m  ZERO DEATH
- [x] Queue                 2m    ZERO DEATH
- [x] Stack                 2m    ZERO DEATH
### Sort
- [x] QuickSort             3m    ZERO DEATH
...
- [x] CompareBinaryTrees    1m    ZERO DEATH
- [x] BFSGraphMatrix        5m    
- [x] DFSGraphList          3m    ZERO DEATH
- [x] DFSOnBST              2m    ZERO DEATH
- [x] DijkstralList         7m    ZERO DEATH
- [x] LRU                   9m    ZERO DEATH
- [ ] Map                   
- [x] MinHeap               8m    ZERO DEATH
- [ ] Trie                  
#### Challenge
- [x] MazeSolver            5m    ZERO DEATH
total  -------------------  87m   XX ZERO DEATHS
...
- [x] ArrayList             6m    ZERO DEATH
- [x] SinglyLinkedList      11m   ZERO DEATH
- [x] DoublyLinkedLists     ||    ZERO DEATH
- [x] Queue                 2m    ZERO DEATH
- [x] Stack                 3m    ZERO DEATH
### Sort
- [x] QuickSort             3m    ZERO DEATH
...
- [x] DFSGraphList          4m    ZERO DEATH
- [x] DFSOnBST              1m    ZERO DEATH
- [x] DijkstralList         9m    ZERO DEATH
- [x] LRU                   9m    ZERO DEATH
- [ ] Map                   
- [x] MinHeap               7m    ZERO DEATH
- [ ] Trie                  
#### Challenge
- [x] MazeSolver            5m    ZERO DEATH
- [x] TwoCrystalBalls       1m    ZERO DEATH
...
- [x] DFSGraphList          5m    ZERO DEATH
- [x] DFSOnBST              1m    ZERO DEATH
- [x] DijkstralList         12m   ZERO DEATH
- [x] LRU                   10m   ZERO DEATH
- [ ] Map                   
- [x] MinHeap               10m
- [ ] Trie                  
...
- [x] Ring Buffer           5m    Z
## Linke Lists              
- [x] SinglyLinkedList      20m   forget to increment length
...
#### Challenge              
- [x] MazeSolver            5m    Z
- [x] TwoCrystalBalls       1m    
total  -------------------  125m  20/23 ZERO DEATHS
--------------------------------------
# Jun 29 2023
## Lists------------------------------
- [x] ArrayList             9m    Z
...
- [x] DFSGraphList          5m    
- [x] DFSOnBST              2m    Z
- [x] DijkstralList         10m   Z   remove seen array
- [x] LRU                   10m   
- [x] Map                   12m   Z
- [x] MinHeap               10m   Z
- [x] Trie                  20m   Z
...
- [x] Ring Buffer           7       Z
#### Linke Lists------------------------
- [x] SinglyLinkedList      4       Z
- [x] DoublyLinkedLists     12      Z
- [x] Queue                 5       Z
- [x] Stack                 5       Z
#### Sort-------------------------------
- [x] QuickSort             4       Z
...
#### Linke Lists------------------------
- [x] SinglyLinkedList      10      Z
- [x] DoublyLinkedLists     11      Z
- [x] Queue                 2       Z
- [x] Stack                 6       Z
#### Sort-------------------------------
- [x] QuickSort             45      getting the medium of 3 working
- [x] MergeSort             3       Z
- [x] InsertionSort         1       Z
- [x] BubbleSort            1       Z
#### Search-----------------------------
